# https://github.com/QuantestPy/quantestpy/blob/6799675c9326d026e01dec6c6600306de03825d4/test/with_qiskit/simulator/state_vector_circuit/test_ry_gate.py
import unittest
...
class TestStateVectorCircuitRyGate(unittest.TestCase):
    ...
    $ python -m unittest \
        test.with_qiskit.simulator.state_vector_circuit.test_ry_gate
    ....
    ----------------------------------------------------------------------
