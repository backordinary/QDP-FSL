# https://github.com/JordanovSJ/VQE/blob/cf740a8b67a7fe3f50a340d1722d0c4ff14083eb/test/test_qiskit_backend.py
    ...
    def test_exponent_statevectors(self):
        ...
        for qubit_operator in qubit_operators:
            ...
            for angle in range(10):
                ...
                exp_matrix = MatrixUtils.get_excitation_matrix(1j * qubit_operator, n_qubits, angle).todense()
