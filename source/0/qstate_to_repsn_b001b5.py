# https://github.com/chiragfalor/iQuHack-2023/blob/ccc738f862e0ca21be7552cac0453bafae753f51/qstate_to_repsn.py
# import packages
...
class EntangledPersonalityState(QuantumPersonalityState):
    ...
    def __init__(self, personality_traits, friend_traits):
        ...
        self.qc.h(range(3))
        self.qc.cx(0, 0+self.NUM_QUBITS)
        self.qc.cx(1, 1+self.NUM_QUBITS)
        self.qc.cx(2, 2+self.NUM_QUBITS)
        self.apply_personality_gates()
