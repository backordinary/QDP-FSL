# https://github.com/ArfatSalman/qc-test/blob/9ec9efff192318b71e8cd06a49abc676196315cb/warnings/sample_distribution_differences/morphq/53_baa269/followup_baa269a2d8614740a19f4203c18cdbce.py
# SECTION
# NAME: PROLOGUE
...
backend_23883971c4e84d71be4bb88e2dd97d2b = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_23883971c4e84d71be4bb88e2dd97d2b, shots=2771).result().get_counts(qc)
RESULT = counts
