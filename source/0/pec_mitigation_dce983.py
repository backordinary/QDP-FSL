# https://github.com/aakif-akhtar/error_mitigation/blob/070f3ebc2a332b87b8fcdf5119a72dfa742a5d57/pec_mitigation.py
...
def objective_function_zne(params):
    ...
    def executor(ansatz):
        ...
        qubit_op = vqe(ansatz_id=1).create_hamiltonian()
    ...
    reps = represent_operations_in_circuit_with_local_depolarizing_noise(ansatze, noise_level)
    ...
    pec_expval = pec.execute_with_pec(ansatze, executor, representations=reps, num_samples=128)#default = 1024
    print("mitigated expectation:", pec_expval)
    return pec_expval
