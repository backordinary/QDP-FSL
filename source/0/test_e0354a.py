# https://github.com/KevinJoven11/iQuHack-2023/blob/de88bcc28c9daf386a073e12ba26e38d6cc51809/test.py
import qiskit
...
def downsizing_2(sample_img):
    ...
    break_pt = [14,28]
    test_img[0,0] = round(np.mean(sample_img[14*0:break_pt[0],14*0:break_pt[0]]),5)
    test_img[0,1] = round(np.mean(sample_img[14*0:break_pt[0],14*1:break_pt[1]]),5)
    test_img[1,0] = round(np.mean(sample_img[14*1:break_pt[1],14*0:break_pt[0]]),5)
    test_img[1,1] = round(np.mean(sample_img[14*1:break_pt[1],14*1:break_pt[1]]),5)
    return test_img
