# https://github.com/QuantestPy/quantestpy/blob/6799675c9326d026e01dec6c6600306de03825d4/test/with_qiskit/simulator/state_vector_circuit/test_h_gate.py
import unittest
...
class TestStateVectorCircuitHGate(unittest.TestCase):
    """
    How to execute this test:
    $ pwd
    {Your directory where you git-cloned quantestpy}/quantestpy
    $ python -m unittest \
        test.with_qiskit.simulator.state_vector_circuit.test_h_gate
    ..
    ----------------------------------------------------------------------
    ...
    def test_ch_control_value_1(self,):
        qc = QuantumCircuit(3)
        qc.ch(0, 1)
    ...
    def test_ch_control_value_0(self,):
        qc = QuantumCircuit(3)
        qc.ch(0, 1, None, "0")
        expected_gate = np.array(Operator(qc))
