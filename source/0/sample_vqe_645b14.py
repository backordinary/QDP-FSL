# https://github.com/Qiskit-Partners/qiskit-runtime/blob/b59cb2e9286d160d37c89d3755d00bf89037cb54/tutorials/sample_vqe_program/sample_vqe.py
...
def main(backend, user_messenger,
    ...
    if x0:
        ...
        if x0.shape[0] != num_params:
            raise ValueError('Number of params in x0 ({}) does not match number of ansatz parameters ({})'. format(
    ...
    # All other SciPy optimizers here
        ...
        res = opt.minimize(vqe_func, x0, method=optimizer, options=optimizer_config, callback=callback)
