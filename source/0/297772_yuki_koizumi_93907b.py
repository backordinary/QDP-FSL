# https://github.com/JavierPerez21/QuantumComputingChallenges/blob/eec39d9ee290f4614374404c67efee50c3453f60/IBMQuantumChallengeFall2021/topscorers/297772_Yuki_KOIZUMI.py
"""
...
def solver_function(L1: list, L2: list, C1: list, C2: list, C_max: int) -> QuantumCircuit:
    ...
    def cost_calculation(index_qubits: int, data_qubits: int, list1: list, list2: list, to_gate = True) -> Union[Gate, QuantumCircuit]:
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*0+0], qr_data[5+2*(0+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*0+0], qr_data[5+2*(0+1) - 2] )
        else:
            val2 = New_C2[5*0+0]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*0+1], qr_data[5+2*(1+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*0+1], qr_data[5+2*(1+1) - 2] )
        else:
            val2 = New_C2[5*0+1]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*0+2], qr_data[5+2*(2+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*0+2], qr_data[5+2*(2+1) - 2] )
        else:
            val2 = New_C2[5*0+2]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*0+3], qr_data[5+2*(3+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*0+3], qr_data[5+2*(3+1) - 2] )
        else:
            val2 = New_C2[5*0+3]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*0+4], qr_data[5+2*(4+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*0+4], qr_data[5+2*(4+1) - 2] )
        else:
            val2 = New_C2[5*0+4]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*1+0], qr_data[5+2*(0+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*1+0], qr_data[5+2*(0+1) - 2] )
        else:
            val2 = New_C2[5*1+0]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*1+1], qr_data[5+2*(1+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*1+1], qr_data[5+2*(1+1) - 2] )
        else:
            val2 = New_C2[5*1+1]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*1+2], qr_data[5+2*(2+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*1+2], qr_data[5+2*(2+1) - 2] )
        else:
            val2 = New_C2[5*1+2]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*1+3], qr_data[5+2*(3+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*1+3], qr_data[5+2*(3+1) - 2] )
        else:
            val2 = New_C2[5*1+3]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*1+4], qr_data[5+2*(4+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*1+4], qr_data[5+2*(4+1) - 2] )
        else:
            val2 = New_C2[5*1+4]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*2+0], qr_data[5+2*(0+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*2+0], qr_data[5+2*(0+1) - 2] )
        else:
            val2 = New_C2[5*2+0]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*2+1], qr_data[5+2*(1+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*2+1], qr_data[5+2*(1+1) - 2] )
        else:
            val2 = New_C2[5*2+1]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*2+2], qr_data[5+2*(2+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*2+2], qr_data[5+2*(2+1) - 2] )
        else:
            val2 = New_C2[5*2+2]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*2+3], qr_data[5+2*(3+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*2+3], qr_data[5+2*(3+1) - 2] )
        else:
            val2 = New_C2[5*2+3]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
        ...
        ##############################
            ...
            for l in range(len_val2):
                if bin_val2[l] == '1' and len_val2 == 2:
                    qc.cx(qr_index[5*2+4], qr_data[5+2*(4+1) - 1- l] ) 
                elif bin_val2[l] == '1':
                    qc.cx(qr_index[5*2+4], qr_data[5+2*(4+1) - 2] )
        else:
            val2 = New_C2[5*2+4]
            bin_val2 = bin(val2)[2:]
            len_val2 = len(bin_val2)
    ...
    def penalty_dephasing(data_qubits: int, alpha: float, gamma: float,  to_gate = True) -> Union[Gate, QuantumCircuit]:
        ...
        n = 5
        qc.cp(alpha*gamma*(2**0),qr_f[0],qr_data[0])
        qc.cp(alpha*gamma*(2**1),qr_f[0],qr_data[1])
        qc.cp(alpha*gamma*(2**2),qr_f[0],qr_data[2])
        qc.cp(alpha*gamma*(2**3),qr_f[0],qr_data[3])
