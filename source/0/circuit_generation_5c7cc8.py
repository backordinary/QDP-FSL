# https://github.com/USCCACS/DS_Compilers_Full_Stack_Package/blob/40f22aa4fde80023bf5b22c14fb47f835b3fbf0f/circuit_generation.py
...
class Heisenberg:
    ...
    def __init__(self,file="input_file.txt", logfile="log.txt"):
        #%matplotlib inline 
        ...
        self.print_bool=0 #controls print statements for DS compiler integration
        self.ds_bool=False #controls transpiling in presence of DS compilation
        self.circuits_list=[]
        self.backend="ibm"
        ...
        self.default_compiler="native" #native or ds
        self.compile="y"
        ...
        if "y" in self.compile:
            if self.JZ != 0 and self.JX==self.JY==0 and self.h_ext!=0 and self.ext_dir=="X" and self.auto_ds_compile=="y":
                ...
                for circuit in self.ibm_circuits_list:
                    compiled=ds_compile(circuit,self.backend, self.shots)
