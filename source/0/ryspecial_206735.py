# https://github.com/CharlesKocher/simulating-mss-qc-on-quantum-computers/blob/c1d1d30189320ae37868fee5c00fc3aa5a5aaa91/qiskit-env/variational_forms/ryspecial.py
# -*- coding: utf-8 -*-
...
class VarFormRYSpecial(VariationalForm):
    ...
    RYSpecial_CONFIGURATION = {
        'name': 'RYSpecial',
        'description': 'RYSpecial Variational Form',
        'input_schema': {
    ...
    def __init__(self, configuration=None):
        super().__init__(configuration or self.RYSpecial_CONFIGURATION.copy())
        self._num_qubits = 0
        self._depth = 0
