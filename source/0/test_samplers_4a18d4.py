# https://github.com/nlaanait/qcdenoise/blob/e4f364389e345d236f1b1993c2025b1b1394370e/tests/test_samplers.py
...
from qiskit.test.mock.backends import FakeMontreal, FakeToronto, FakeTokyo
...
def test_DeviceNoiseSampler(get_circuit_device_dict, n_qubits):
    ...
    try:
        prob_vec = sampler.sample(
            circuit_dict["circuit"], user_backend=True)
        assert prob_vec.shape == (2**n_qubits,)
    except BaseException:
        pytest.fail()
