# https://github.com/simonetome/QuantumGeneticAlgorithm/blob/798e90b6eab76d7d3e44ef6fffbbe80900ad7284/GQA/quantum/gqa_qiskit.py
...
class GQA_qiskit:
    ...
    def run_generation(self):
        ...
        for c in self.rotations:
          for i in range(0,m):
            qc.ry(self.rotations[c][i],int(c*m+i))
