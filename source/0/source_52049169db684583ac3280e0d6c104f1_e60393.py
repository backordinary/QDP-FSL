# https://github.com/ArfatSalman/qc-test/blob/9ec9efff192318b71e8cd06a49abc676196315cb/warnings/sample_distribution_differences/qdiff/52_520491/source_52049169db684583ac3280e0d6c104f1.py
...
qc.append(CCXGate(), qargs=[qr[7], qr[0], qr[1]], cargs=[])
...
backend_55f5ef1c55df4ef992079534811a3759 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_55f5ef1c55df4ef992079534811a3759, shots=2771).result().get_counts(qc)
RESULT = counts