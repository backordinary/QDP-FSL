# https://github.com/sonamghosh/quantum-machine-learning/blob/4aefea2fe86d9195391aac11faf424237fe08888/01_Classical_and_Quantum_Probability_Distributions/assignment_helper.py
import itertools
import numpy as np
import socket
import subprocess
