# https://github.com/qiskrypt/qiskrypt/blob/8f00358100e14b2aaed8020dec43ca57434d3502/src/quantum_regime/cryptography/key_exchange/quantum_key_distribution/dv/prepare_and_measure/bb84/noiseless/with_no_eavesdropping/QiskryptNoiselessDVBB84ProtocolWithNoEavesdropping.py
"""
                ...
                if isinstance(sender_secret_sifted_key, QiskryptSecretSiftedKey) and \
                    ...
                    if sender_secret_sifted_key_length == receiver_secret_sifted_key_length:
                        ...
                        num_rounds_parameter_estimation_sample = \
                            int((DV_BB84_PROTOCOL_DEFAULT_FACTOR_FOR_NUM_ROUNDS_OF_PARAMETER_ESTIMATION_SAMPLE *
                        ...
                        if z_basis_quantum_bits_total > 0:
                            ...
                            Noiseless DV (Discrete Variables) BB84 Protocol with No Eavesdropping.
                            """
