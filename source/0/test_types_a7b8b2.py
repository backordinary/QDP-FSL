# https://github.com/unitaryfund/mitiq/blob/aab51f7c4e9f623da6ff83eff60c1a9a8950e52b/mitiq/pec/types/tests/test_types.py
...
def test_representation_sample_seed():
    ...
    0, sign1, coeff1 = decomp.sample(random_state=seed1)
    0, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    1, sign1, coeff1 = decomp.sample(random_state=seed1)
    1, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    2, sign1, coeff1 = decomp.sample(random_state=seed1)
    2, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    3, sign1, coeff1 = decomp.sample(random_state=seed1)
    3, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    4, sign1, coeff1 = decomp.sample(random_state=seed1)
    4, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    5, sign1, coeff1 = decomp.sample(random_state=seed1)
    5, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    6, sign1, coeff1 = decomp.sample(random_state=seed1)
    6, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    7, sign1, coeff1 = decomp.sample(random_state=seed1)
    7, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    8, sign1, coeff1 = decomp.sample(random_state=seed1)
    8, sign2, coeff2 = decomp.sample(random_state=seed2)

    assert sign1 == sign2
    assert np.isclose(coeff1, coeff2)
    9, sign1, coeff1 = decomp.sample(random_state=seed1)
    9, sign2, coeff2 = decomp.sample(random_state=seed2)
