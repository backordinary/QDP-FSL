# https://github.com/SashwatAnagolum/DoNew/blob/e2391d482ee54acb0fad38ca586243468f73b7eb/QNN/qnn.py
"""
...
def GLayer(qc, qreg, params):
    ...
    """
    qc.append(GGate(qc, qreg, params[0]), [qreg[0]])
    qc.append(GGate(qc, qreg, params[1]), [qreg[1]])
...
def CGLayer(qc, qreg, anc, params):
    ...
    qc.append(GGate(
        qc, qreg, params[0]
    ).control(1), [anc[0], qreg[0]])
    qc.append(GGate(
        qc, qreg, params[1]
    ).control(1), [anc[0], qreg[1]])
