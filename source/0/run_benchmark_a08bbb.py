# https://github.com/peiyi1/nassc_code/blob/06f96bd461f44daa41cccb03a2f76604d4471dde/test_HardwareAware_strategy_using_backed_up_data/test_CouplingMap_FullyConnected/run_benchmark.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
