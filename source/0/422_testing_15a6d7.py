# https://github.com/Serock3/Master_thesis_QEC_simulation/blob/bfc808d5e73b7e0bc77f7a36bdc373f7d27a4c8f/trash/422_testing.py
...
fid, circ, res, times = encoding_fidelity_422(n_shots, gate_times={},
                  T1=40e3, T2=60e3,
                  idle_noise=True, initial_state=state_list[0], 
                  include_swap=False,
                  transpile=True,
                  snapshot_type='dm', project=False)
fid_list.append(fid)
...
fid, circ, res, times = encoding_fidelity_422(n_shots, gate_times={},
                  T1=40e3, T2=60e3,
                  idle_noise=True, initial_state=state_list[1], 
                  include_swap=False,
                  transpile=True,
                  snapshot_type='dm', project=False)
fid_list.append(fid)
...
fid, circ, res, times = encoding_fidelity_422(n_shots, gate_times={},
                  T1=40e3, T2=60e3,
                  idle_noise=True, initial_state=state_list[2], 
                  include_swap=False,
                  transpile=True,
                  snapshot_type='dm', project=False)
fid_list.append(fid)
...
fid, circ, res, times = encoding_fidelity_422(n_shots, gate_times={},
                  T1=40e3, T2=60e3,
                  idle_noise=True, initial_state=state_list[3], 
                  include_swap=False,
                  transpile=True,
                  snapshot_type='dm', project=False)
fid_list.append(fid)
...
lower = order[:0].sum(axis=0)
plt.fill_between(time, (order[0]+lower)*counts_at_snapshots, lower*counts_at_snapshots,
                 color=np.array(colors(0))-np.array([0, 0, 0, 0.3]))
plt.plot(time, ((order[0]+lower)*counts_at_snapshots), '.', color=colors(0))
lower = order[:1].sum(axis=0)
plt.fill_between(time, (order[1]+lower)*counts_at_snapshots, lower*counts_at_snapshots,
                 color=np.array(colors(1))-np.array([0, 0, 0, 0.3]))
plt.plot(time, ((order[1]+lower)*counts_at_snapshots), '.', color=colors(1))
lower = order[:2].sum(axis=0)
plt.fill_between(time, (order[2]+lower)*counts_at_snapshots, lower*counts_at_snapshots,
                 color=np.array(colors(2))-np.array([0, 0, 0, 0.3]))
plt.plot(time, ((order[2]+lower)*counts_at_snapshots), '.', color=colors(2))
