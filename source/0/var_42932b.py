# https://github.com/lucasfriedrich97/Natural-evolutionary-strategies-applied-to-quantum-classical-hybrid-neural-network/blob/a82b49b5e2b43982d6d5996f060a38ec50c03df2/var_.py
import numpy as np
import math as m
import torch
