# https://github.com/entropicalabs/openqaoa/blob/1887f413775385a30f91cd414bed49dcb943120b/tests/test_sim_qiskit.py
...
class TestingQAOAQiskitSimulatorBackend(unittest.TestCase):
    ...
    def test_get_wavefunction(self):
        ...
        try:
            ...
            assert np.allclose(np.real(np.conjugate(wf_qiskit_statevec)*wf_qiskit_statevec),
