# https://github.com/alt-shreya/HeisenBugs/blob/d3b2eaa2db22e5949a6be45b74213d2e953b13fa/part-1_test_qiskit.py
import qiskit
...
for data in dataset:
    ...
    img= cv2.resize(np.array(data["image"]),(2,2))
    #image_re.reshape(4, 4)

    # calculate mse
    mse += image_mse(img, image_re)
