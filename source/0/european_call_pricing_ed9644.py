# https://github.com/jongjinna/Quantum_IBM/blob/00b793d13526bc7ccb782b2e8d381c3a6e5834ae/IBM_Finance/European_Call_Pricing.py
...
print(european_call_delta._objective.decompose().draw())
...
print(european_call_delta_circ.draw())
