# https://github.com/teaguetomesh/VQE/blob/7c3afde179e4bc304e4163471fe521c1121c7d37/Ansatz/UCCSD_Barkoutsos.py
'''
...
def DoubleExcitationOperator(circ, theta, s, r, q, p):
    ...
    circ = U_d(1, circ, s, r, q, p, dagger=False)
    ...
    circ = U_d(1, circ, s, r, q, p, dagger=True)

    circ = U_d(2, circ, s, r, q, p, dagger=False)
    ...
    circ = U_d(2, circ, s, r, q, p, dagger=True)

    circ = U_d(3, circ, s, r, q, p, dagger=False)
    ...
    circ = U_d(3, circ, s, r, q, p, dagger=True)

    circ = U_d(4, circ, s, r, q, p, dagger=False)
    ...
    circ = U_d(4, circ, s, r, q, p, dagger=True)

    circ = U_d(5, circ, s, r, q, p, dagger=False)
    ...
    circ = U_d(5, circ, s, r, q, p, dagger=True)

    circ = U_d(6, circ, s, r, q, p, dagger=False)
    ...
    circ = U_d(6, circ, s, r, q, p, dagger=True)

    circ = U_d(7, circ, s, r, q, p, dagger=False)
    ...
    circ = U_d(7, circ, s, r, q, p, dagger=True)

    circ = U_d(8, circ, s, r, q, p, dagger=False)
    ...
    circ = U_d(8, circ, s, r, q, p, dagger=True)
