# https://github.com/bagmk/Quantum_Machine_Learning_Express/blob/027c25c568c6d784ff680b8bf96f5322df75c0e7/ML/quantumcircuit.py
...
def cir_ex(qc,qr,currentParams):
    ...
    count=0;
    qc.rx(currentParams[count],qr[0])
    count=count+1
    qc.rx(currentParams[count],qr[1])
    count=count+1
    qc.rz(currentParams[count],qr[0])
    count=count+1
    qc.rz(currentParams[count],qr[1])
    count=count+1
    qc.cz(qr[0],qr[1])
...
def cir_ex_4(qc,qr,currentParams):
    ...
    qc.rx(currentParams[count],qr[1])
    count=count+1
    qc.rx(currentParams[count],qr[2])
    count=count+1
    qc.rx(currentParams[count],qr[3])
    count=count+1
    qc.rz(currentParams[count],qr[0])
    count=count+1
    qc.rz(currentParams[count],qr[1])
    count=count+1
    qc.rz(currentParams[count],qr[2])
    count=count+1
    qc.rz(currentParams[count],qr[3])
    count=count+1
