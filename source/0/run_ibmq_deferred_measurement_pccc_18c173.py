# https://github.com/lanl/Quantum-Telecloning/blob/783d854083cc01f52cdcf3f2124bb2b8cd1cffa0/run_experiments/run_IBMQ_deferred_measurement_PCCC.py
"""
...
def get_transpiled_circuits(angle_ry, angle_rz):
	qc_tc, clone_indices, _ = construct_deferred_measurement_PCCC(angle_ry, angle_rz)
...
job_filename = "PCCC_"+device_name+subgraph_name+"_"+str(N_shots)+"_"+str(N_Angle_slices)+"_OPT_"+str(OPT_LEVEL)+".txt"
