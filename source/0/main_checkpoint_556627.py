# https://github.com/LucianoPereiraValenzuela/Parallel_QND_measurement_tomography/blob/913a2ee9b393338066da6f16ecf2b0b8452bf159/codes/.ipynb_checkpoints/main-checkpoint.py
import sys
sys.path.append('../')
import numpy as np
