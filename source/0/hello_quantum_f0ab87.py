# https://github.com/qiskit-community/qiskit-community-tutorials/blob/6de54e7033edc4233142caecda257ed72a6735f5/games/game_engines/hello_quantum.py
...
class pauli_grid():
    ...
    def update_grid(self,rho=None,labels=False,bloch=None,hidden=[],qubit=True,corr=True,message=""):
        ...
        def see_if_unhidden(pauli):
            ...
            if qubit==False:
                unhidden = unhidden and (pauli[0] in ['I','Z'])
                unhidden = unhidden and (pauli[1] in ['I','Z'])
