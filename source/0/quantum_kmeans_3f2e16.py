# https://github.com/Apress/Quantum-Computing-Solutions/blob/66161505d3f4a1dc0b401912b06afacf796521de/chapter10/quantum_kmeans.py
...
quantum_circuit.u3(theta_list[1], phi_list[1], 0, quantumregister[1]) 
...
quantum_circuit.u3(theta_list[0], phi_list[0], 0, quantumregister[0])           
quantum_circuit.u3(theta_list[2], phi_list[2], 0, quantumregister[1]) 
...
quantum_circuit.u3(theta_list[0], phi_list[0], 0, quantumregister[0])           
quantum_circuit.u3(theta_list[3], phi_list[3], 0, quantumregister[1]) 
