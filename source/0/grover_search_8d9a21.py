# https://github.com/pnnl/nwqbench/blob/a7b829c0be0e63c5302855ee3214e7dbe8c4dda2/NWQ_Bench/grover_search/grover_search.py
import numpy as np
...
new_circuit.measure(new_circuit.qubits[0],cbits[0])
new_circuit.measure(new_circuit.qubits[1],cbits[1])
new_circuit.measure(new_circuit.qubits[2],cbits[2])
while True:
