# https://github.com/rocdawn12/double_cross_resonance_gate/blob/1daaf6c751aca768396690d4f19963b70bee7599/base.py
#!/usr/bin/env python
...
def get_circuit_name(target_time, trotter_steps, order, hs, c2r, dphi, ncx, prefix='fc'):
    if target_time<=1e-10:
        target_time = 0.0
    return "{}_{}_s{}_o{}_n{}_r{:.2f}_d{:.2f}_t{:.2f}".format(prefix, hs, trotter_steps, order, ncx, c2r, dphi, target_time)
