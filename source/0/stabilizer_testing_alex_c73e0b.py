# https://github.com/Serock3/Master_thesis_QEC_simulation/blob/bfc808d5e73b7e0bc77f7a36bdc373f7d27a4c8f/trash/stabilizer_testing_alex.py
# %% Import modules
import numpy as np
...
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][1]

log1 = logical[1][np.arange(128,step=4)]
#sv_test = sv_post_encoding[np.arange(128,step=4)]
sv_test = sv_post_encoding[0:32]
fid += state_fidelity(log1, sv_test)
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][2]

log1 = logical[1][np.arange(128,step=4)]
#sv_test = sv_post_encoding[np.arange(128,step=4)]
sv_test = sv_post_encoding[0:32]
fid += state_fidelity(log1, sv_test)
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][3]

log1 = logical[1][np.arange(128,step=4)]
#sv_test = sv_post_encoding[np.arange(128,step=4)]
sv_test = sv_post_encoding[0:32]
fid += state_fidelity(log1, sv_test)
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][4]

log1 = logical[1][np.arange(128,step=4)]
#sv_test = sv_post_encoding[np.arange(128,step=4)]
sv_test = sv_post_encoding[0:32]
fid += state_fidelity(log1, sv_test)
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][5]

log1 = logical[1][np.arange(128,step=4)]
#sv_test = sv_post_encoding[np.arange(128,step=4)]
sv_test = sv_post_encoding[0:32]
fid += state_fidelity(log1, sv_test)
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][6]

log1 = logical[1][np.arange(128,step=4)]
#sv_test = sv_post_encoding[np.arange(128,step=4)]
sv_test = sv_post_encoding[0:32]
fid += state_fidelity(log1, sv_test)
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][7]

log1 = logical[1][np.arange(128,step=4)]
#sv_test = sv_post_encoding[np.arange(128,step=4)]
sv_test = sv_post_encoding[0:32]
fid += state_fidelity(log1, sv_test)
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][8]

log1 = logical[1][np.arange(128,step=4)]
#sv_test = sv_post_encoding[np.arange(128,step=4)]
sv_test = sv_post_encoding[0:32]
fid += state_fidelity(log1, sv_test)
sv_post_encoding = results.data()['snapshots']['statevector']['stabilizer_0'][9]
