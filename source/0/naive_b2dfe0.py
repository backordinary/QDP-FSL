# https://github.com/banrovegrie/PauliZee/blob/0f93e14dfd00c6b87e84c9b58532a2b13a4b89f9/src/naive.py
# -*- coding: utf-8 -*-
"""
...
def performance():
    timestamps = []
    total_time, circ, res = main(2=2, t=2, state=None)
    timestamps.append(total_time)
    total_time, circ, res = main(3=3, t=2, state=None)
    timestamps.append(total_time)
    total_time, circ, res = main(4=4, t=2, state=None)
    timestamps.append(total_time)
    total_time, circ, res = main(5=5, t=2, state=None)
    timestamps.append(total_time)
