# https://github.com/shubhranshsinghvi/VQE/blob/70e7df42c14a510313a3859f60429b43fa33b6b9/Qiskit/lab3/grading_tools/grade.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
def check_answer(answer, lab_name, exercise_name, participant_name, participant_email,
    ...
    if answer is None:
        ...
        if answer_response['is_valid']:
            ...
            if 'owner does not match request owner' in answer_response['cause']:
                print(answer_response['cause'], '...Retrying with a fresh session...')
