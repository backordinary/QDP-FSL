# https://github.com/ArlineQ/arline_benchmarks/blob/d93ab31415fa400c5bf01a7fa0b0bf65db867336/arline_benchmarks/strategies/voqc_1q_gates_cancel.py
...
_strategy_class_name = "VoqcSingleQubitCancel"


class VoqcSingleQubitCancel(CompressionStrategy):
    r"""VOQC Single-Qubit Gates Cancellation Strategy
    """
