# https://github.com/5l1v3r1/learning-quantum-computing-course/blob/f2fcb3892345c09db00ce11cac18fb96d7c244db/assets/notebooks/templates/jupyter/qiskit/jupyter-notebook-qiskit-template-2.py
#!/usr/bin/env python
# coding: utf-8
