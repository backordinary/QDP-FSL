# https://github.com/Mohammad-Khatami/grover-protein-desing/blob/b946f36a0f398359da19bdfac962c280e1db8c07/codes/SP-model/6designable-3-4-5-interactions/6res-3inter-m6-iter-1-E11.py
#!/usr/bin/env python
...
with open('6res-3inter-m6-iter-1-E11.txt', 'w') as file:
    file.write(str(data))
