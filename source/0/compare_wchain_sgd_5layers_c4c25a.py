# https://github.com/vutuanhai237/UC-VQA/blob/a913edd393a291b54afa9b7ae9dfed71157bbdcb/codes/tomography/multiprocessing_scripts/compare_Wchain_sgd_5layers.py
import qiskit
import numpy as np
import sys
sys.path.insert(1, '../')
