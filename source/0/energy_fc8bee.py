# https://github.com/Quantum-Computing-Cooperation/Quantum_Hackathon_2021/blob/69bb50ebd93cbc2bdca59de360408a5a2ecd6f2e/some_completed_notebooks/energy_levels_not_commented/energy.py
import qiskit
import numpy as np
