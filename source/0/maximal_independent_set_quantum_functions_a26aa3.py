# https://github.com/fjelljenta/Smart-Charging/blob/f4f7a2fe26802690460dd5d20edb412ef613640a/web_app/console_simulation/Maximal_independent_set_quantum_functions.py
...
def brut_force_k4_N5(G):
    ...
    C_opt = 0
    P_try = {'P0': [0], 'P1': [], 'P2': [], 'P3': []}
    P_try['P' + str(0)].append(1)
    P_try['P' + str(0)].append(2)
    P_try['P' + str(0)].append(3)
    P_try['P' + str(0)].append(4)
    C_try = cost(G, P_try)
    if C_try > C_opt:
        P = P_try.copy()
        C_opt = C_try
