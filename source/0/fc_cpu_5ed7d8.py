# https://github.com/jerry910525/2022_intern/blob/ac3c3f74103015e234fed3141b99b29cec36170c/intern_codes/qnn_mnist/fc_cpu.py
# -*- coding: utf-8 -*-
"""
this code take qunatum layer as fully connected layer to classify the MNIST dataset from 0 to 9.
it use CPU to train the model.
"""
...
class HybridFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        gradients = np.array([gradients],dtype = float).T
