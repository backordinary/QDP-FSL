# https://github.com/agnostiQ/DQC1-knots/blob/620b7802e95dddd9f33870aa12a9299e313d7e5d/DQC13twirl.py
#Numpy/scipy imports
import numpy as np

#QISkit imports
from qiskit import QuantumCircuit, ClassicalRegister, QuantumRegister, QISKitError, qasm, compile
...
def getProg(opSequence, qc, qr, cr, weight=1, inState='o', mBasis='x'):
    """
...
def buildJob(opSeq, shots, backend, reps):
    ...
    qcArr = 4*reps*(dimW1+dimW2)*['']
    names = 4*reps*(dimW1+dimW2)*['']
