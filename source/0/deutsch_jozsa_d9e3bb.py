# https://github.com/jclapis/qsfe/blob/941488f8f8a81a4b7d7fe28414ce14fa478a692a/Qiskit/QiskitOracles/deutsch_jozsa.py
# ========================================================================
...
class DeutschJozsa(unittest.TestCase):
    ...
    def test_nth_qubit_parity(self):
        ...
        """
        self.run_test(f"q{0} parity check", oracles.check_if_qubit_is_one, False, 10, 0)
        self.run_test(f"q{1} parity check", oracles.check_if_qubit_is_one, False, 10, 1)
        self.run_test(f"q{2} parity check", oracles.check_if_qubit_is_one, False, 10, 2)
        self.run_test(f"q{3} parity check", oracles.check_if_qubit_is_one, False, 10, 3)
        self.run_test(f"q{4} parity check", oracles.check_if_qubit_is_one, False, 10, 4)
        self.run_test(f"q{5} parity check", oracles.check_if_qubit_is_one, False, 10, 5)
        self.run_test(f"q{6} parity check", oracles.check_if_qubit_is_one, False, 10, 6)
        self.run_test(f"q{7} parity check", oracles.check_if_qubit_is_one, False, 10, 7)
        self.run_test(f"q{8} parity check", oracles.check_if_qubit_is_one, False, 10, 8)
        self.run_test(f"q{9} parity check", oracles.check_if_qubit_is_one, False, 10, 9)
