# https://github.com/jclapis/qsfe/blob/941488f8f8a81a4b7d7fe28414ce14fa478a692a/Qiskit/QiskitOracles/Simon/simon.py
# ========================================================================
...
def wiki_test_function(circuit, input, output):
    ...
    circuit.x(input[0])
    circuit.cx(input[0], output[0])
    circuit.cx(input[1], output[0])
