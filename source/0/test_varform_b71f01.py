# https://github.com/rsln-s/variationaltoolkit/blob/e76522694d44c2568a50d19edb7d5b50330721ff/test/test_varform.py
import unittest
import numpy as np
...
class TestVarForm(unittest.TestCase):
    ...
    def test_qaoa_pass_mixer(self):
        ...
        beta = Parameter('beta')
        mixer_circuit.h(0)
        mixer_circuit.rz(2*beta, 0)
        mixer_circuit.h(0)
        mixer_circuit.h(1)
        mixer_circuit.rz(2*beta, 1)
        mixer_circuit.h(1)
        mixer_circuit.h(2)
        mixer_circuit.rz(2*beta, 2)
        mixer_circuit.h(2)
        mixer_circuit.h(3)
        mixer_circuit.rz(2*beta, 3)
        mixer_circuit.h(3)
