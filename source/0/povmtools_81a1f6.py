# https://github.com/Firepanda415/Bayesian-Denoise-Paper/blob/c89c48b270dfe35b2c1a1f8c54d0e1e1ca83a986/QREM/povmtools.py
# -*- coding: utf-8 -*-
"""
...
def get_su2_parametrizing_angles(m_a):
    ...
    if abs(angles[0]) < eps_angles:
        angles[0] = 0
    if abs(angles[1]) < eps_angles:
        angles[1] = 0
    if abs(angles[2]) < eps_angles:
        angles[2] = 0
