# https://github.com/daglarcoban/distributed-quantum-computing/blob/11b971ffd98c9035cc0e4345941ed47ac5d4c121/src/shor_code_variants/n_clusters_of_n/shor_code_3_clusters_of_3.py
import numpy as np
...
if __name__ == '__main__':
    ...
    circ.measure(circ.qregs[0][0], circ.cregs[4 * 0 + 0])
    circ.measure(circ.qregs[0][1], circ.cregs[4 * 0 + 1])
    circ.measure(circ.qregs[0][2], circ.cregs[4 * 0 + 2])
    circ.measure(circ.qregs[0][3], circ.cregs[4 * 0 + 3])
    circ.measure(circ.qregs[1][0], circ.cregs[4 * 1 + 0])
    circ.measure(circ.qregs[1][1], circ.cregs[4 * 1 + 1])
    circ.measure(circ.qregs[1][2], circ.cregs[4 * 1 + 2])
    circ.measure(circ.qregs[1][3], circ.cregs[4 * 1 + 3])
    circ.measure(circ.qregs[2][0], circ.cregs[4 * 2 + 0])
    circ.measure(circ.qregs[2][1], circ.cregs[4 * 2 + 1])
    circ.measure(circ.qregs[2][2], circ.cregs[4 * 2 + 2])
    circ.measure(circ.qregs[2][3], circ.cregs[4 * 2 + 3])
