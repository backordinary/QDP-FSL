# https://github.com/ghuioio/effective_dimension_test/blob/e652138b1544ce8c403d53ad2ecd35ecb557674d/Noise_plots/training/generate_data/hard_qnn_noise_train.py
...
f1 = 'quantum_loss_hard_noise_%d.npy' %41
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%41
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %42
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%42
np.save(f2, opt_params)
print('index: %s' % 43)
np.random.seed(43)
d = 8  # num of trainable params
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %43
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%43
np.save(f2, opt_params)
print('index: %s' % 44)
np.random.seed(44)
d = 8  # num of trainable params
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %44
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%44
np.save(f2, opt_params)
print('index: %s' % 45)
np.random.seed(45)
d = 8  # num of trainable params
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %45
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%45
np.save(f2, opt_params)
print('index: %s' % 46)
np.random.seed(46)
d = 8  # num of trainable params
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %46
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%46
np.save(f2, opt_params)
print('index: %s' % 47)
np.random.seed(47)
d = 8  # num of trainable params
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %47
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%47
np.save(f2, opt_params)
print('index: %s' % 48)
np.random.seed(48)
d = 8  # num of trainable params
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %48
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%48
np.save(f2, opt_params)
print('index: %s' % 49)
np.random.seed(49)
d = 8  # num of trainable params
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %49
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%49
np.save(f2, opt_params)
print('index: %s' % 50)
np.random.seed(50)
d = 8  # num of trainable params
...
opt_params, value, _, loss = optimizer.optimize(len(init_params), objective_function,
                                                gradient_function=grad_function,
                                                initial_point=init_params)
f1 = 'quantum_loss_hard_noise_%d.npy' %50
np.save(f1, loss)
f2 = 'opt_params_hard_noise_%d.npy'%50
np.save(f2, opt_params)