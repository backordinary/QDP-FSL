# https://github.com/dreaming-panda/quantum-ml/blob/360b18fa53bf05108c4b50036ce10553712fd79f/examples/allright/allright.py
...
plt.title("allright_result")
plt.savefig('allright_result.jpg')
index = []
