# https://github.com/ArlineQ/arline_benchmarks/blob/d93ab31415fa400c5bf01a7fa0b0bf65db867336/arline_benchmarks/strategies/voqc_2q_gates_cancel.py
...
_strategy_class_name = "VoqcTwoQubitCancel"


class VoqcTwoQubitCancel(CompressionStrategy):
    r"""VOQC Two-Qubit Gates Cancellation Strategy
    """
