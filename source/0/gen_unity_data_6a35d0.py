# https://github.com/mickahell/quantum_pokemon-fight/blob/22524e997bc885db41271169432a468041d59fdf/train/gen_unity_data.py
...
###################################################
        ...
        print("Fight {} is finished !".format(0 + 1))
        # Types creation --> Sources : https://boutique-pokemon.com/blogs/blog-pokemon/table-types-pokemon
        fire = Type("Fire")
        normal = Type("Normal")
        water = Type("Water")
...
###################################################
        ...
        print("Fight {} is finished !".format(1 + 1))
