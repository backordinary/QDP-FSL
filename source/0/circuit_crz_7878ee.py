# https://github.com/achieveordie/HybridQNN/blob/9bc236216cfcf6eaff7c2d7becbcc930d161c7ba/circuits/circuit_crz.py
"""
A Two-Qubit circuit with a single parameter `theta`, where
they are prepared into |++> states followed by a Controlled-RZ
Gate where the first qubit acts as the control and second
qubit is the target where RZ(theta) is applied, only the second
...
class QuantumCircuit:
    ...
    def __init__(self, n_qubits, backend, shots):
        ...
        self._circuit.crz(self.theta, 0, 1)
