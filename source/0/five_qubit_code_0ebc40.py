# https://github.com/Arkonaire/Quantum-Algorithms/blob/38e1bde53810e5d17f5112b04fcb9abeabbe6359/Quantum%20Error%20Correction/five_qubit_code.py
import numpy as np
...
class FiveQubitCode:
    ...
    def __init__(self):
        ...
        self.noise_ckt.unitary(Operator(np.eye(2)), [self.code[3]], label='noise')
        self.noise_ckt.unitary(Operator(np.eye(2)), [self.code[4]], label='noise')
