# https://github.com/NEEL-NINAD-SHAHAKAR/netsquid-QKD/blob/041c56103cfe012da66b36226ed78594c5e96749/qiskit-BB84.py
# Importing Qiskit
from qiskit import *
...
print(encoded_qubits[2])
print(encoded_qubits[3])
print(encoded_qubits[4])
print("etc.")
