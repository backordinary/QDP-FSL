# https://github.com/zommiommy/quantum_research/blob/6a345e02894140a08f8c2b1d87bab89ff48b5605/Minimum_Spanning_Tree/qiskit_implementation/weight_encoding/edge_finder/simulator.py
...
class Simulator():
    ...
    @time_function
    def symbolic_simulation(self, circuit : QuantumCircuit, threshold : float = 1e-6) -> None:
