# https://github.com/qiskit-community/qiskit-presentations/blob/d5690616ada7b14ab4d091e5ecc87755f6d6a18a/2018-09-07_TechCrunch/demos/AI/run_classify_local.py
# -*- coding: utf-8 -*-
...
def classify(datapoints):
    ...
    for tin in range(2*len(test_input[class_labels[0]])):
        ...
        if Lsign[tin] == test_label[tin]:
            success_ratio += 1
    success_ratio_vec[0] = success_ratio/(2*len(test_input[class_labels[0]]))
