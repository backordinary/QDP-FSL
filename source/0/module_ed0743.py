# https://github.com/FriederikeButt/QEL_Merck_Challenge/blob/365677a14840fdb8bfac0a36f69ec23ef31b2bfc/algorithm/module.py
import sys, os
import pathlib
...
if (pred_labels[1][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
print(testing_data[2])
if (pred_labels[2][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
print(testing_data[3])
if (pred_labels[3][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
print(testing_data[4])
if (pred_labels[4][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
print(testing_data[5])
if (pred_labels[5][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
print(testing_data[6])
if (pred_labels[6][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
print(testing_data[7])
if (pred_labels[7][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
print(testing_data[8])
if (pred_labels[8][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
print(testing_data[9])
if (pred_labels[9][0] == 0. ):
    print('not AD')
else:
    print('AD')
print('######################################################')
