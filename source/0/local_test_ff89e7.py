# https://github.com/lanl/quantum_algorithms/blob/9aaaa6635aee8a39fa8cb68e7e4b193851dcebde/subroutines/QAOA/util/local_test.py
#!/usr/bin/env python3
...
result = qp.execute(['superposition'], backend='local_qasm_simulator', shots=1000)
