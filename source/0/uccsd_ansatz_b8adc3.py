# https://github.com/teaguetomesh/quantum_circuit_generator/blob/904877914b48a6ef4176f9c0dcbfffc0e509b860/VQE/uccsd_ansatz.py
'''
...
class UCCSD:
    ...
    def DoubleExcitationOperator(self, theta, p, q, r, s):
        ...
        self.M_d(1, p, q, r, s, dagger=False)
        ...
        self.M_d(1, p, q, r, s, dagger=True)

        if self.barriers:
            self.circ.barrier(qr)

        self.M_d(2, p, q, r, s, dagger=False)
        ...
        self.M_d(2, p, q, r, s, dagger=True)

        if self.barriers:
            self.circ.barrier(qr)

        self.M_d(3, p, q, r, s, dagger=False)
        ...
        self.M_d(3, p, q, r, s, dagger=True)

        if self.barriers:
            self.circ.barrier(qr)

        self.M_d(4, p, q, r, s, dagger=False)
        ...
        self.M_d(4, p, q, r, s, dagger=True)

        if self.barriers:
            self.circ.barrier(qr)

        self.M_d(5, p, q, r, s, dagger=False)
        ...
        self.M_d(5, p, q, r, s, dagger=True)

        if self.barriers:
            self.circ.barrier(qr)

        self.M_d(6, p, q, r, s, dagger=False)
        ...
        self.M_d(6, p, q, r, s, dagger=True)

        if self.barriers:
            self.circ.barrier(qr)

        self.M_d(7, p, q, r, s, dagger=False)
        ...
        self.M_d(7, p, q, r, s, dagger=True)

        if self.barriers:
            self.circ.barrier(qr)

        self.M_d(8, p, q, r, s, dagger=False)
        ...
        self.M_d(8, p, q, r, s, dagger=True)
