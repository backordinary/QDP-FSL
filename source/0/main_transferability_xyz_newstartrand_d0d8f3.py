# https://github.com/AntMele/Avoiding-Barren-Plateaus-via-transferability-of-smooth-solutions-in-hamiltonian-variational-ansatz/blob/fecd219024ff0b039a09030c723b860b7aa0186a/main_transferability_XYZ_NewStartRand.py
import numpy as np
import os
import sys
...
EdGuess_file = f"temp_results_XYZ/file_Opt_NewStartRand_r{randN}_deltaY={deltaY}_deltaZ={deltaZ}_L={Lguess}_P={P}_maxiter={iterguess}.npz"
...
file_TR = f"temp_results_XYZ/transf_XYZ_NewStartRand_r{randN}_Lguess={Lguess}_deltaY={deltaY}_deltaZ={deltaZ}_P={P}_maxiter={iterguess}.npz"
