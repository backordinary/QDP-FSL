# https://github.com/epiqc/PartialCompilation/blob/50d80f56efdf754e40a0b1dd00404788a03fdf3d/scripts/qaoa/gen_circuits.py
"""
...
def main():
    ...
    n6r3_list = list()
    n8r3_list = list()
    n6e_circuits = get_N6_erdosrenyi_qaoa_circuits_to_compile(1)
    n8e_circuits = get_N8_erdosrenyi_qaoa_circuits_to_compile(1)
    n6r3_circuits = get_N6_3reg_qaoa_circuits_to_compile(1)
    n8r3_circuits = get_N8_3reg_qaoa_circuits_to_compile(1)
    ...
    n6e_circuits = get_N6_erdosrenyi_qaoa_circuits_to_compile(2)
    n8e_circuits = get_N8_erdosrenyi_qaoa_circuits_to_compile(2)
    n6r3_circuits = get_N6_3reg_qaoa_circuits_to_compile(2)
    n8r3_circuits = get_N8_3reg_qaoa_circuits_to_compile(2)
    ...
    n6r3_list.append((n6r3_rz_indices, n6r3_circuits))
    n8r3_list.append((n8r3_rz_indices, n8r3_circuits))
    n6e_circuits = get_N6_erdosrenyi_qaoa_circuits_to_compile(3)
    n8e_circuits = get_N8_erdosrenyi_qaoa_circuits_to_compile(3)
    n6r3_circuits = get_N6_3reg_qaoa_circuits_to_compile(3)
    n8r3_circuits = get_N8_3reg_qaoa_circuits_to_compile(3)
    ...
    n6r3_list.append((n6r3_rz_indices, n6r3_circuits))
    n8r3_list.append((n8r3_rz_indices, n8r3_circuits))
    n6e_circuits = get_N6_erdosrenyi_qaoa_circuits_to_compile(4)
    n8e_circuits = get_N8_erdosrenyi_qaoa_circuits_to_compile(4)
    n6r3_circuits = get_N6_3reg_qaoa_circuits_to_compile(4)
    n8r3_circuits = get_N8_3reg_qaoa_circuits_to_compile(4)
    ...
    n6r3_list.append((n6r3_rz_indices, n6r3_circuits))
    n8r3_list.append((n8r3_rz_indices, n8r3_circuits))
    n6e_circuits = get_N6_erdosrenyi_qaoa_circuits_to_compile(5)
    n8e_circuits = get_N8_erdosrenyi_qaoa_circuits_to_compile(5)
    n6r3_circuits = get_N6_3reg_qaoa_circuits_to_compile(5)
    n8r3_circuits = get_N8_3reg_qaoa_circuits_to_compile(5)
    ...
    n6r3_list.append((n6r3_rz_indices, n6r3_circuits))
    n8r3_list.append((n8r3_rz_indices, n8r3_circuits))
    n6e_circuits = get_N6_erdosrenyi_qaoa_circuits_to_compile(6)
    n8e_circuits = get_N8_erdosrenyi_qaoa_circuits_to_compile(6)
    n6r3_circuits = get_N6_3reg_qaoa_circuits_to_compile(6)
    n8r3_circuits = get_N8_3reg_qaoa_circuits_to_compile(6)
    ...
    n6r3_list.append((n6r3_rz_indices, n6r3_circuits))
    n8r3_list.append((n8r3_rz_indices, n8r3_circuits))
    n6e_circuits = get_N6_erdosrenyi_qaoa_circuits_to_compile(7)
    n8e_circuits = get_N8_erdosrenyi_qaoa_circuits_to_compile(7)
    n6r3_circuits = get_N6_3reg_qaoa_circuits_to_compile(7)
    n8r3_circuits = get_N8_3reg_qaoa_circuits_to_compile(7)
    ...
    n6r3_list.append((n6r3_rz_indices, n6r3_circuits))
    n8r3_list.append((n8r3_rz_indices, n8r3_circuits))
    n6e_circuits = get_N6_erdosrenyi_qaoa_circuits_to_compile(8)
    n8e_circuits = get_N8_erdosrenyi_qaoa_circuits_to_compile(8)
    n6r3_circuits = get_N6_3reg_qaoa_circuits_to_compile(8)
    n8r3_circuits = get_N8_3reg_qaoa_circuits_to_compile(8)
