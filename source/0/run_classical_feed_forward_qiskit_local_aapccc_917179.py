# https://github.com/lanl/Quantum-Telecloning/blob/783d854083cc01f52cdcf3f2124bb2b8cd1cffa0/classical_simulation_code/run_classical_feed_forward_Qiskit_local_AAPCCC.py
"""
...
def run(angle_ry, angle_rz):
	...
	qc_tc_original, clone_indices, rho = construct_AAPCCC_Honeywell_QASM_circuit_Qiskit_version(angle_ry, angle_rz, True)
	...
	qc_tc_original, clone_indices, _ = construct_deferred_measurement_APCC(angle_ry, angle_rz)
