# https://github.com/born-2learn/AutoBellCircuit/blob/fafd43fb10d3371783a1f3ed23efc120b94faf11/qpower_app.py
import numpy as np
from qiskit import *
...
class GradientDescentOptimizer:
    ...
    def optimize_circuit_sgd(self, qc, quantum_circuit_parameter, angle_degrees, cost_function='mse', learning_rate = 2):
        ...
        while i<max_i and previous_step_size>precision: #iterating over until the error converges
            ...
            job = execute(qc, backend = Aer.get_backend('qasm_simulator'), shots = self.shots, parameter_binds=[{quantum_circuit_parameter: theta_radians}])
            counts = job.result().get_counts()
            
            print(counts)
            try:
                prob_avg_01 = counts['01']/self.shots
                
            except:
                prob_avg_01 = 0
            try:
                prob_avg_10 = counts['10']/self.shots
            except:
                prob_avg_10 = 0
