# https://github.com/UST-QuAntiL/QuantME-UseCases/blob/1f735d97de87da80a58584f3aa19cdab1b0da27e/2021-icws/docker/initialized-winery/services/classification/circuitExecutor.py
...
class CircuitExecutor():
    ...
    @classmethod
    def runCircuit(cls, circuit: QuantumCircuit, parameterizations: list, backend, token, shots,
