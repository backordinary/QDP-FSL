# https://github.com/theheavygluon/alice-n-bob/blob/2c0ebe486055d7ac5396c91e58a9eefacbc4e5a6/Education/E91_QuantumInspire.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 30 10:41:29 2022
E91_QuantumInspire: For the iQuHack
...
email, pasword = "arenstein@ime.usp.br", "594AT121g1wcApQC4hMe"
...
def run_circuits(numberOfSinglets, aliceMeasurements, bobMeasurements):
    ...
    #We already called the backend that is provided by Quantum Inspire :)
    #This should take some time to run 
    results = backend.run(circuits, shots=1).result().get_counts()
    
    return aliceMeasurementChoices, bobMeasurementChoices, results

#print(circuits[0])pir
#0:A2_B3
#print(circuits[2])
#1:A2_B3
...
#python3 E91_QuantumInspire.py n
