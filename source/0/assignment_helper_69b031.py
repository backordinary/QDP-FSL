# https://github.com/MochizukiShinichi/Quantum_Machine_Learning_Solution/blob/e5ef6fc11b8f5a77db40334036bea2c8983a8ae1/coding_assignments/assignment_helper.py
import itertools
import numpy as np
import scipy
import socket
