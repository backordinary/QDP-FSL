# https://github.com/seyurlutchminarain/Quantum-Africa-Challenge/blob/85f5945906ddb83f77411e6f551929fa8edf2f3b/3_Final/qc_grader.py
...
def grade_ex1(
    ...
    if correct:
        print(f"🌟 Correct! Your macro-molecule is defined correctly!")
...
def grade_ex2(q1_answer: str, q2_answer: str):
    ...
    if correct:
        print(f"🌟 Correct! Your answers to the two questions are right!")
...
def grade_ex3(
    ...
    if correct:
        print(f"🌟 Correct! Your energy results and function parameters are correct!")
...
def grade_ex5(
    ...
    if correct:
        print(f"🌟 Correct! Your solution is valid.")
