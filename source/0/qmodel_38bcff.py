# https://github.com/dreaming-panda/quantum-ml/blob/109436d1aea5e15c856b7400cefa4e4d43723098/qmodel.py
...
class MNISTMODEL(QModel):
    def forward(self):
        for x in self.weights:
            self.qc.h(x)
        self.qc.barrier()
        self.qc.mcx(control_qubits=[self.weights[0], self.features[0]], target_qubit=self.ancilla_bits[0])
        self.qc.mcx(control_qubits=[self.weights[1], self.features[1]], target_qubit=self.ancilla_bits[1])
        self.qc.mcx(control_qubits=[self.weights[2], self.features[2]], target_qubit=self.ancilla_bits[2])
        self.qc.mcx(control_qubits=[self.weights[3], self.features[3]], target_qubit=self.ancilla_bits[3])
        self.qc.mcx(control_qubits=[self.weights[4], self.features[4]], target_qubit=self.ancilla_bits[4])
        self.qc.mcx(control_qubits=[self.weights[5], self.features[5]], target_qubit=self.ancilla_bits[5])
        self.qc.mcx(control_qubits=[self.weights[6], self.features[6]], target_qubit=self.ancilla_bits[6])
        self.qc.mcx(control_qubits=[self.weights[7], self.features[7]], target_qubit=self.ancilla_bits[7])
        self.qc.mcx(control_qubits=[self.weights[8], self.features[8]], target_qubit=self.ancilla_bits[8])
        self.qc.barrier()
        self.qc.x(self.ancilla_bits[0])
        self.qc.x(self.ancilla_bits[1])
        self.qc.x(self.ancilla_bits[2])
