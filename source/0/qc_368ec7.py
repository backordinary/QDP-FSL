# https://github.com/Deravadom/PostQuantumComputation/blob/96f95fdcf1c6db139cbfafcbe6d99bed5cdddd5a/shors/code/qc.py
import numpy as np
...
def qpe(qc, n, angle):
    ...
    # Applies Hadamard to the first n qubits
    qc = h_all(qc, n)
    qc.x(n)
    qc.barrier()
