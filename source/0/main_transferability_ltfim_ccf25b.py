# https://github.com/AntMele/Avoiding-Barren-Plateaus-via-transferability-of-smooth-solutions-in-hamiltonian-variational-ansatz/blob/fecd219024ff0b039a09030c723b860b7aa0186a/main_transferability_LTFIM.py
import numpy as np
import os
import sys
...
if run_ED:
    ...
    if os.path.isfile(outfile_ED):
        ...
        raise Exception("No ED results file for these TFIM parameters")
...
file_TR = f"temp_results_LTFIM/transf_LTFIM_Lguess={Lguess}_g={g}_h={h}_P={P}_{ans}_maxiter={iterguess}_sign={sign}.npz"
