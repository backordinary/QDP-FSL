# https://github.com/Indi-Quantum-Community/Qiskit-Summer-School-Program-Notes/blob/a3559f674b9bdf6bbb1f65e1e6feeb0ae3f7c458/lab1/grading_tools/grade.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
def grade(answer=None, name=None, email=None, labid=None, exerciseid=None,
    ...
    if is_update and "Correct" in result:
