# https://github.com/Tihulu/quantumcomputing/blob/9064b1bb9cb670f1546d5843a1aee7655e415f99/project/test.py
"""
...
if __name__ == '__main__':
    ...
    et=int(et)
    nt=int(nt)
    n=math.ceil(math.log2(nt))
    t = 2*n+1+math.ceil(math.log2(2+1/(2*0.1)))
    bitn=2*n+3
    print(t, 'val of t, val of n bit length:',n)
    print(bitn, 'val of qubit numb')
    # conttt=input('press to continue')
    ...
    # IBMQ.enable_account(token,hub='ibm-q-education', group='mid-east-tech-un-1', project='2300343-Intro-Computational-Methods')
    # IBMQ.save_account(token,hub='ibm-q-education', group='mid-east-tech-un-1', project='2300343-Intro-Computational-Methods')
...
######          RSA
    ...
    # message = input("What would you like to decrypt?(Separate numbers with ',' :")
    message = [83, 33, 94, 75, 76, 2, 51, 88, 33, 94]
