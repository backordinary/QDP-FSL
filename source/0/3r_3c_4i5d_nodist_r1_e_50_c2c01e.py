# https://github.com/Mohammad-Khatami/grover-protein-desing/blob/b946f36a0f398359da19bdfac962c280e1db8c07/codes/MR-model/3designable-3interaction/3r_3c_4i5d_nodist_r1_e.50.py
#!/usr/bin/env python
import numpy as np
