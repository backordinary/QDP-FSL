# https://github.com/CharlesKocher/simulating-mss-qc-on-quantum-computers/blob/c1d1d30189320ae37868fee5c00fc3aa5a5aaa91/qiskit-env/variational_forms/ryspecialfull2.py
# -*- coding: utf-8 -*-
...
class VarFormRYSpecialFull2(VariationalForm):
    """Full set of Y rotations."""

    RYSpecialFull2_CONFIGURATION = {
        'name': 'RYSpecialFull2',
        'description': 'RYSpecialFull2 Variational Form',
        'input_schema': {
            '$schema': 'http://json-schema.org/schema#',
            'id': 'ryspecialfull2_schema',
            'type': 'object',
            'properties': {
                'depth': {
                    'type': 'integer',
    ...
    def __init__(self, configuration=None):
        super().__init__(configuration or self.RYSpecialFull2_CONFIGURATION.copy())
        self._num_qubits = 0
        self._depth = 0
