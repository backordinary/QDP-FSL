# https://github.com/Tihulu/quantumcomputing/blob/9064b1bb9cb670f1546d5843a1aee7655e415f99/project/rsaqattack.py
...
et=int(et)
nt=int(nt)
ntt=math.ceil(math.log2(nt))
tt = 2*ntt+1+math.ceil(math.log2(2+1/(2*0.1)))
bitn=2*ntt+3
print(tt, 'val of t, val of n bit length:',ntt)
