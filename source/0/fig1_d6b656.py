# https://github.com/dprovasoli/QuantumPartonShower/blob/aa2e15ac5822a438cb7afc27b74abd3780f8feb8/PaperPlots/Fig1.py
###########################################################
...
lnt_max_list[0]=[]
lnt_max_list[100]=[]
quantum_0 = np.load("quantum_0_"+str(0)+".npy")
quantum_100 = np.load("quantum_100_"+str(0)+".npy")
lnt_max_list[0.].append(quantum_0)
lnt_max_list[100].append(quantum_100)
pass
quantum_0 = np.load("quantum_0_"+str(1)+".npy")
quantum_100 = np.load("quantum_100_"+str(1)+".npy")
lnt_max_list[0.].append(quantum_0)
lnt_max_list[100].append(quantum_100)
pass
quantum_0 = np.load("quantum_0_"+str(2)+".npy")
quantum_100 = np.load("quantum_100_"+str(2)+".npy")
lnt_max_list[0.].append(quantum_0)
lnt_max_list[100].append(quantum_100)
pass
quantum_0 = np.load("quantum_0_"+str(3)+".npy")
quantum_100 = np.load("quantum_100_"+str(3)+".npy")
lnt_max_list[0.].append(quantum_0)
lnt_max_list[100].append(quantum_100)
pass
quantum_0 = np.load("quantum_0_"+str(4)+".npy")
quantum_100 = np.load("quantum_100_"+str(4)+".npy")
lnt_max_list[0.].append(quantum_0)
lnt_max_list[100].append(quantum_100)
pass
quantum_0 = np.load("quantum_0_"+str(5)+".npy")
quantum_100 = np.load("quantum_100_"+str(5)+".npy")
lnt_max_list[0.].append(quantum_0)
lnt_max_list[100].append(quantum_100)
pass
