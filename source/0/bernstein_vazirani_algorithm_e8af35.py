# https://github.com/a-menaf-altintas/quantum-computing/blob/037c240c36d52e1240147266d2fdb719f1916283/bernstein-vazirani-algorithm.py
#!/usr/bin/env python
# coding: utf-8
...
for qubit, number in enumerate(input_string[::-1]):
    if number == "1":
