# https://github.com/KB00100100/paper-QSLT/blob/c1593a5c44d41f36ba4d0d4d88ca2e21242c0c9a/SVM_iris.py
...
for i in range(1,101):
    X_train, y_train, X_test, y_test = iris(training_size=28, test_size=12, n=num_qubits, plot_data=False, one_hot=False)
    #print(y_train)
