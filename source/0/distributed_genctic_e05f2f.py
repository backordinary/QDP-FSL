# https://github.com/cxygiao/DQC/blob/a426f53b331d4ab594402037fdfc8ecf8193000a/distributedQuantum/distributed_genctic.py
# toffoli门的隐形传态
# 2022.1.21
# cxy
...
'''合并传输求隐形传态次数'''
def tc_num_by_merge(gate_list,all_line_sequence,initial_line_sequence,qbit):

    # initial_line_sequence = single_to_all_line_sequence(line_sequence, qbit)  # ABCDEF GHIJKL
    new_gate_list = list_str_to_int(gate_list)
    # all_line_sequence = single_to_all_line_sequence(line_sequence, qbit)  # ABCDEG FHIJKL
    ...
    print('相邻的全局门的隐形传态次数：' + str(toffoli_result_list[1]))
...
#     input_filename = 'E:/python/project/qasm/sym6_316.qasm'
...
#     gate_list = converter_circ_from_qasm(input_filename)[0]
   ...
   #  print(gate_list)
    ...
    # print(tc_num_by_merge(gate_list,line_sequence_combination[0],qbit))
#
