# https://github.com/unitaryfund/mitiq/blob/caa9b67dcc3fe5e0d998f21350df57a832eddfc7/mitiq/zne/scaling/tests/test_folding.py
...
def test_global_fold_moment_structure_maintained_full_scale_factors():
    ...
    circuit1 += Circuit(gate_list1[1](qreg[1]))
    circuit1 += Circuit(gate_list1[2](qreg[2]))
    circuit1 += Circuit(gate_list1[3](qreg[3]))
