# https://github.com/Mohammad-Khatami/grover-protein-desing/blob/b946f36a0f398359da19bdfac962c280e1db8c07/codes/SP-model/3designable-2interaction/3res-2inter-m5-iter-1-E7.py
#!/usr/bin/env python
