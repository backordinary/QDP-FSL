# https://github.com/Lucaman99/Quantum-Computing/blob/6b63911297829d7f4d5286bcf6fe93b2bf2fb231/qiskit/VQT/qiskit_vqt.py
...
def cost_function(param):
    ...
    p = []
    p.append(opt_prob_dist[0][0]*opt_prob_dist[1][0]*opt_prob_dist[2][0])
    p.append(opt_prob_dist[0][0]*opt_prob_dist[1][0]*opt_prob_dist[2][1])
    p.append(opt_prob_dist[0][0]*opt_prob_dist[1][1]*opt_prob_dist[2][0])
    p.append(opt_prob_dist[0][0]*opt_prob_dist[1][1]*opt_prob_dist[2][1])
    p.append(opt_prob_dist[0][1]*opt_prob_dist[1][0]*opt_prob_dist[2][0])
    p.append(opt_prob_dist[0][1]*opt_prob_dist[1][0]*opt_prob_dist[2][1])
    p.append(opt_prob_dist[0][1]*opt_prob_dist[1][1]*opt_prob_dist[2][0])
    p.append(opt_prob_dist[0][1]*opt_prob_dist[1][1]*opt_prob_dist[2][1])
