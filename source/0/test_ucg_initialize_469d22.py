# https://github.com/qclib/qclib/blob/4a9063314a0930bdebf70d008ac100456cab117f/test/test_ucg_initialize.py
...
class TestUCGInitialize(TestCase):
    ...
    def test_ucg_preserve(self):
        ...
        self._test_ucg_preserve(3)
        self._test_ucg_preserve(4)
