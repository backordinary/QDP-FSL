# https://github.com/alexandrupaler/qxx/blob/1cfc77341b2021203aa33c5647feb4267c38a54a/papers/arxiv:new/training.py
import qiskit
...
with open("circuits_analysis.csv", "w",  buffering=1) as csvFile:
    ...
    for depth in depth_range[gdv_name]:
        analysis = (depth, 0) + circuit_analysis(depth, 0)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 1) + circuit_analysis(depth, 1)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 2) + circuit_analysis(depth, 2)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 3) + circuit_analysis(depth, 3)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 4) + circuit_analysis(depth, 4)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 5) + circuit_analysis(depth, 5)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 6) + circuit_analysis(depth, 6)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 7) + circuit_analysis(depth, 7)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 8) + circuit_analysis(depth, 8)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
    for depth in depth_range[gdv_name]:
        analysis = (depth, 9) + circuit_analysis(depth, 9)
        print(analysis)
        writer.writerow(analysis)
        csvFile.flush()
