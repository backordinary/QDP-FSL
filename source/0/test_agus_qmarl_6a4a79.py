# https://github.com/agustinsilva447/QMARL/blob/bdfd66fda61d365789ba484cf81c3ff5723a19bb/other%20files/test_agus_qmarl.py
import numpy as np
...
class Agent:
    def __init__(self, n_anctions, epsilon_0=0.1):
