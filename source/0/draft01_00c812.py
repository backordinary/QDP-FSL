# https://github.com/husisy/learning/blob/ff16cf8a4e2638455f5b89b2fb683f99d0164c53/python/qiskit/draft01.py
import numpy as np
...
def get_raw_results(code, noise_model=None):
    ...
    raw_results = {}
    job = qiskit.execute( circuits[0], Aer.get_backend('qasm_simulator'), noise_model=noise_model)
    raw_results[str(0)] = job.result().get_counts(str(0))
    job = qiskit.execute( circuits[1], Aer.get_backend('qasm_simulator'), noise_model=noise_model)
