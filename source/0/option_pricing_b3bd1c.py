# https://github.com/SchmidtMoritz/QT2_Group_Challenge/blob/c5c1e1ffb0b33ff9eed363e4a4c55759ebddb302/option_pricing.py
...
# draw the circuit
european_call.draw(output='mpl').show()
...
european_call_delta.decompose().draw(output='mpl').show()
