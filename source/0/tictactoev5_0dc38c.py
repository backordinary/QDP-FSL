# https://github.com/honlin96/Qubit-Tic-Tac-Toe/blob/14f15a510c9903de2a7377ca3bed0e8e067b4b28/IBM-Q-Award/tictactoev5.py
# -*- coding: utf-8 -*-
"""
...
class MainApp:                         ### (1)
    ...
    #create 3x3 boxes
        self.buttons = []
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 0=0 :self.btnClick(0)))
        ...
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 1=1 :self.btnClick(1)))
        #Note: command lambda i=i to ensure the value i is stored and passed into the function when the button is created
        self.buttons[1].grid(row= 5 + math.floor(1/3), column=1%3)
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 2=2 :self.btnClick(2)))
        #Note: command lambda i=i to ensure the value i is stored and passed into the function when the button is created
        self.buttons[2].grid(row= 5 + math.floor(2/3), column=2%3)
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 3=3 :self.btnClick(3)))
        #Note: command lambda i=i to ensure the value i is stored and passed into the function when the button is created
        self.buttons[3].grid(row= 5 + math.floor(3/3), column=3%3)
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 4=4 :self.btnClick(4)))
        #Note: command lambda i=i to ensure the value i is stored and passed into the function when the button is created
        self.buttons[4].grid(row= 5 + math.floor(4/3), column=4%3)
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 5=5 :self.btnClick(5)))
        #Note: command lambda i=i to ensure the value i is stored and passed into the function when the button is created
        self.buttons[5].grid(row= 5 + math.floor(5/3), column=5%3)
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 6=6 :self.btnClick(6)))
        #Note: command lambda i=i to ensure the value i is stored and passed into the function when the button is created
        self.buttons[6].grid(row= 5 + math.floor(6/3), column=6%3)
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 7=7 :self.btnClick(7)))
        #Note: command lambda i=i to ensure the value i is stored and passed into the function when the button is created
        self.buttons[7].grid(row= 5 + math.floor(7/3), column=7%3)
        self.buttons.append(Button(text=" ", font='Times 20 bold', bg='gray', fg='white', height=4, width=8,command=lambda 8=8 :self.btnClick(8)))
        #Note: command lambda i=i to ensure the value i is stored and passed into the function when the button is created
