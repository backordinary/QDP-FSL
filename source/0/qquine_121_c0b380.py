# https://github.com/Advanced-Research-Centre/QPULBA/blob/42ecc9c6e556fe0e5cb7b352f863271365969f02/qquine_121.py
import numpy as np
import random
...
count_constructors(deepcopy(qcirc),0)
count_constructors(deepcopy(qcirc),1)
count_constructors(deepcopy(qcirc),2)
