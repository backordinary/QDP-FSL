# https://github.com/FiQCI/helmi-examples/blob/4c80fe1f14e1a51cf3427f83495d284fff3cab30/qiskit/qb_flip_qiskit.py
...
def main():
    ...
    if args.option == 1:
        ...
        print(" ")
        flip_qubits(backend_dict, 0, 1)
        flip_qubits(backend_dict, 1, 1)
        flip_qubits(backend_dict, 2, 1)
        flip_qubits(backend_dict, 3, 1)
        flip_qubits(backend_dict, 4, 1)
